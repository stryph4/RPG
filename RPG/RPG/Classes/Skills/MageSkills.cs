...
namespace RPG.Classes
{
    public class MageSkills
    {
        ...
        //    CombatMethods.combatLog.Insert(0, $"You converted {hero.MaxMP / 20} into a shield that absorbs damage.");
        //}

        ////private static void CastFireball(Combatant hero, Combatant enemy, string skill, double critChance)
        ////{
        //    hero.MP -= 20;
        //    double damage = CombatMethods.SpellAttack(hero, enemy);
        //    if (critChance <= hero.CriticalHitRate)
        //    {
        //        damage *= 2;
        //        damage = CombatMethods.AbsorbCalculator(enemy, (int)damage);
        //        CombatMethods.combatLog.Insert(0, $"Your fireball hit {enemy.Name} for {(int)damage} damage (CRITICAL).");
        //        enemy.HP -= (int)damage;
        ...
        //    {
        //        damage = CombatMethods.AbsorbCalculator(enemy, (int)damage);
        //        CombatMethods.combatLog.Insert(0, $"Your fireball hit {enemy.Name} for {(int)damage} damage.");
        //        enemy.HP -= (int)damage;
        //        CombatMethods.yourTurn = false;
        //    }
        //}
